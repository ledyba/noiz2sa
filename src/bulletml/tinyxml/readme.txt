...
It doesn稚 parse or use DTDs (Document Type Definitions) or XSL痴 
...
It痴 not much of a To Do list, but it will do. To read this file 
...
And it痴 ready to go. Now let痴 look at some lines and how they 
relate to the DOM.
...
<?xml version="1.0" standalone=創o
	...
	commands won稚 be lost when it is saved back to disk.
...
<Item priority="1"> 
	...
	This element has 1 attribute, with the name 叢riorityand the value 
	

Go to the 

	A TiXmlText. This is a leaf node and cannot contain other nodes. 
	It is a child of the 選tem" Element.
...
TiXmlDocument				"demo.xml"
	TiXmlDeclaration		"version='1.0'" "standalone=創o
...
I壇 appreciates your suggestions, and would love to know if you 
